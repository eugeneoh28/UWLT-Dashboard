...
global.name = ['Canvas & Catalyst Requests', 'Multimedia Requests', 'Poll Everywhere Tickets']
...
app.get("/", function(req, res) {
  async.series(asynchTasks, function (err, results) {
    res.render("home", {body:results, oldest:oldest, name:name});
  })
});
